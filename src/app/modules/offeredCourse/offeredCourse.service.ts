...
const createOfferedCourseIntoDB = async (payload: TOfferedCourse) => {
   ...
   */
    ...
    const isSemesterRegistrationExists = await SemesterRegistration.findById(semesterRegistration) // get full data 
    if(!isSemesterRegistrationExists){
      throw new Error("SemesterRegistration not found!")
    }

  const academicSemester = isSemesterRegistrationExists.academicSemester; // => new ObjectId('6658aa79e6408a39d7f6bfbe')
  // console.log(academicSemester); // => new ObjectId('6658aa79e6408a39d7f6bfbe')
